...
export default function HolderTypesPage() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">
              {eventData?.event?.name} — Define pass types, entry access and issuing rules
            </p>
          </div>
        </div>
      ...
      {isLoading ? (
        ...
        <Card>
          <div className="text-center py-12 text-gray-500">
            <p className="text-lg mb-2">No pass types yet</p>
            <p className="text-sm">
      ...
      {/* ── Add/Edit Pass Type Modal ────────────────────────────────────── */}
      <Modal
        isOpen={showModal}
        onClose={closeModal}
        title={editing ? "Edit Pass Type" : "Add Pass Type"}
        size="lg"
      ...
      >
        <div className="space-y-4">
          ...
          <Input
            ...
            placeholder="Who is this pass type for?"
          />
